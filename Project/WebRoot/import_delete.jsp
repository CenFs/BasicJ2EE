...
String str1 = request.getParameter("importid");
int importid = 0;
		...
		<center>
			<div class="custom-popup delete-widget-popup delete-confirmation-popup" id="deleteWidgetConfirm">
				...
				<div class="popup-body text-center">
					...
					<form action="import.do?method=delete" method="post">
						<button name="importid" value="<%=importid %>"class="btn btn-success">确认删除</button>
					</form>
