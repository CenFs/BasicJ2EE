					...
					<div class="smart-widget">
						...
						<div class="smart-widget-inner">
							...
							<div class="smart-widget-body">
								<form id="formToggleLine" class="form-horizontal no-margin form-border" action="import.do?method=add" method="post">
									<div class="form-group">
										<label class="col-lg-2 control-label">入库单名称</label>
										<div class="col-lg-10">
											<input name="importname" class="form-control" type="text" placeholder="入库单名称">
										</div><!-- /.col -->
									</div><!-- /form-group -->
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input name="import_remark" class="form-control" rows="3" placeholder="描述本次入库详细信息。"></input>
										</div><!-- /.col -->
									</div><!-- /form-group -->
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<div class="row">
												<div class="col-lg-3">
													<input name="import_quantity" type="text" class="form-control" placeholder="0">
												</div><!-- /.col -->
											</div><!-- /.row -->
										</div><!-- /.col -->
									</div><!-- /form-group -->
